package ru.yandex.practicum.sprint5.k;
...
public final class Solution {
    public static void printRange(final Node root, final int L, final int R, final BufferedWriter writer) throws IOException {
